...
const LoginPage = () => {
  ...
  const handlerLogin = (e) => {
    ...
    logInUser(email, password)
      .then(res => {
        const user = res.user
        console.log("🚀 ~ file: LoginPage.js ~ line 18 ~ handlerLogin ~ user", user)
        form.reset()
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover bg-[url('https://images.unsplash.com/photo-1525302220185-c387a117886e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')] px-10 top-16 absolute z-10">
      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
        ...
        <form onSubmit={handlerLogin} className="card flex-shrink-0 w-full max-w-sm">
        ...
        <span className='text-center mx-auto'>Login with</span>
